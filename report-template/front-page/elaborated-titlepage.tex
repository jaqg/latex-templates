% Temporarily override graphicspath for titlepage figures
...
{\large \defenseDate}\\[4cm] % Date (set \defenseDate in configuration/style.tex)

\vfill
\end{center}
\end{titlepage}
% Restore graphicspath for the main document
